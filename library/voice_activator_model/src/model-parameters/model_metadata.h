 ...
 *
 * This software, documentation and other associated files (collectively
 * referred to as the “Software”) is a single SDK variation generated by the
 * Edge Impulse platform and requires an active paid Edge Impulse subscription
 * to use this Software for any purpose.
 *
 * You may NOT use this Software unless you have an active Edge Impulse
 * subscription that meets the eligibility requirements for the applicable
 * License, subject to your full and continued compliance with the terms and
 * conditions of the License, including without limitation any usage
 * restrictions under the applicable License.
 *
 * If you do not have an active Edge Impulse product plan subscription, or if
 * use of this Software exceeds the usage limitations of your Edge Impulse
 * product plan subscription, you are not permitted to use this Software and
 * must immediately delete and erase all copies of this Software within your
 * control or possession. Edge Impulse reserves all rights and remedies
 * available to enforce its rights.
 *
 * Unless required by applicable law or agreed to in writing, the Software is
 * distributed on an "AS IS" BASIS, WITHOUT WARRANTIES OR CONDITIONS OF ANY
 * KIND, either express or implied. See the License for the specific language
 * governing permissions, disclaimers and limitations under the License.
 */
 ...
 *  model_metadata.h defines if certain functions are enabled or disabled in the
 * whole project.
 */
...
#define EI_CLASSIFIER_PROJECT_ID 1106180
#define EI_CLASSIFIER_PROJECT_OWNER "NitishSingh"
#define EI_CLASSIFIER_PROJECT_NAME                                             \
  "sih hackathon edge triggered device \"Hey Nexus\""
...
#define EI_CLASSIFIER_THRESHOLD 0.50
#define EI_CLASSIFIER_TFLITE_OUTPUT_DATA_TENSOR 0
#define EI_CLASSIFIER_OBJECT_DETECTION_LAST_LAYER                              \
  EI_CLASSIFIER_LAST_LAYER_UNKNOWN
...
#error                                                                         \
    ...
    (EI_CLASSIFIER_TFLITE_LARGEST_ARENA_SIZE == 0)
#error                                                                         \
    "This model cannot run under TensorFlow Lite Micro (EI_CLASSIFIER_TFLITE_LARGEST_ARENA_SIZE is 0). See https://github.com/edgeimpulse/example-standalone-inferencing-linux (build with EI_CLASSIFIER_USE_FULL_TFLITE=1) to use full TensorFlow Lite / LiteRT."
#endif
